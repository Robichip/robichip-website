  ...
  return (
    <footer className="os-footer">
      <div className="os-shell os-footer-grid">
        ...
        <div><h3>Company · 公司</h3><Link href="/company">About RobiChip</Link><Link href="/partnership">Partnership &amp; Ecosystem</Link><Link href="/news-events">News &amp; Events</Link><a href="https://profile.104.com.tw/company/1a2x6bnk3q">Careers ↗</a></div>
