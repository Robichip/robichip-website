(() => {
  ...
  const joinPage = () => `
    ...
    ${section("Why Join RobiChip","Work on the Hardest Part of Intelligent Machines","投入智慧機器最難、也最關鍵的動力瓶頸<br>The next bottleneck in robotics and UAV systems is no longer only control algorithm. It is power integration, thermal path, packaging, validation, and manufacturability.<br><br>機器人與無人機的下一個瓶頸，不只是控制演算法，而是功率整合、熱路徑、封裝、驗證與可製造性。",cards([{tag:"Deep Tech",title:"Power SoC + Thermal Architecture",text:"功率晶片與熱架構<br><br>Work on high-power-density integration across chip, board, package, and system-level heat path."},{tag:"Real Machines",title:"Robotics and UAV Applications",text:"機器人與無人機應用<br><br>Build technology that connects directly to drones, actuators, robot joints, servo modules, and smart motion systems."},{tag:"Validation",title:"Measure, Calibrate, Improve",text:"量測、校準、改善<br><br>Turn engineering assumptions into measured data through RobiDev, RobiLab, RobiThrust, and future RobiTorque workflows."},{tag:"Startup",title:"Build from 0 to 1",text:"從 0 到 1 建構平台<br><br>Join a small team where architecture, product, validation, customer feedback, and partnerships are tightly connected."}],"four"),"tint")}
    ${section("Who We Are Looking For","Builders Across Chip, Power, Thermal, AI, and Systems","尋找能跨晶片、電力、熱、AI 與系統的人才<br>We welcome full-time candidates, senior advisors, project collaborators, research partners, and students who want to work on real power-system challenges.<br><br>我們歡迎全職候選人、資深顧問、專案合作夥伴、研究合作單位，以及想投入真實動力系統問題的學生。",cards([{tag:"Engineering Core",title:"IC / Power Electronics / Motor Drive",text:"晶片、電力電子與馬達驅動<br><br>Power IC / power electronics · BLDC / PMSM motor control · Gate driver / sensing / protection · PCB / module design and bring-up"},{tag:"Thermal & Validation",title:"Thermal / Packaging / RobiLab",text:"熱管理、封裝與量測驗證<br><br>Thermal architecture · Packaging / DFM / reliability · Dynamic load and T-N curve · Measurement and report workflow"},{tag:"System & AI",title:"Robotics / UAV / RobiAgent",text:"機器人、無人機與 AI 輔助工程<br><br>Robotics actuator / UAV propulsion · AI-assisted engineering workflow · Simulation / CAE / DOE support · Customer pilot and field feedback"}]),"tint")}
    ${section("Open Collaboration Tracks","Multiple Ways to Work with RobiChip","多種方式與羅比芯一起合作<br>We are building a focused team and ecosystem. Some roles may be full-time, while others may begin as advisor, project, internship, or research collaboration.<br><br>我們正在建立精實團隊與生態系。有些角色會是全職，有些則可能從顧問、專案、實習或研究合作開始。",cards([{title:"Full-time Core Team",text:"全職核心團隊：work closely on RobiSoC, RobiDev, RobiLab, RobiAgent, RobiThrust, and RobiTorque roadmap."},{title:"Technical Advisor",text:"技術顧問：for senior experts in power electronics, packaging, robotics, UAV, thermal simulation, DFM, reliability, or manufacturing."},{title:"Project Collaboration",text:"專案型合作：for validation, layout, RobiAgent, RobiLab, RobiThrust, RobiTorque, or customer pilot projects."},{title:"Internship / Student Project",text:"實習與學生專題：motor control, thermal measurement, robotics validation, AI tools, or engineering documentation."},{title:"Research / Lab Collaboration",text:"研究與實驗室合作：for university labs and research groups working on power electronics, thermal management, UAV propulsion, or robotic actuators."}],"three")+`<div class="notice"><strong>Current status｜目前狀態：</strong> RobiChip is open to talent discussions, project-based collaboration, internship proposals, and advisor conversations. Specific openings, compensation, scope, NDA, and schedule will be discussed case by case.<br>羅比芯開放人才洽談、專案合作、實習提案與顧問討論。具體職缺、報酬、合作範圍、NDA 與時程，將依個案討論。</div>`,"tint")}
    ...
    ${section("How We Work","Small Team, Real Data, Fast Learning","小團隊、真實數據、快速學習<br>RobiChip is a deep-tech startup. We value people who can move between theory, implementation, measurement, customer feedback, and business reality.<br><br>羅比芯是 deep-tech 新創。我們重視能在理論、實作、量測、客戶回饋與商業現實之間快速切換的人。",cards([{tag:"Evidence-first",title:"Measure Before Overclaiming",text:"先量測，再主張<br><br>We prefer real test data, clear assumptions, and engineering reports over vague claims."},{tag:"System Thinking",title:"Chip to System",text:"從晶片到系統<br><br>We connect silicon, package, board, thermal path, motor, fixture, and customer use case."},{tag:"Ownership",title:"Build and Close the Loop",text:"主動推進並完成閉環<br><br>We value builders who can define a problem, run experiments, document results, and drive next actions."},{tag:"Integrity",title:"Clear Boundary, Clear Promise",text:"清楚邊界，清楚承諾<br><br>We are careful about claims, IP boundaries, customer confidentiality, and partner commitments."}],"four"))}
    ${section("Students & Young Engineers","Learn by Building Real Power Systems","用真實動力系統學習工程<br>RobiChip welcomes students and young engineers who want to learn from real measurement, motor control, thermal validation, AI-assisted engineering, and customer-facing product development.<br><br>羅比芯歡迎想從真實量測、馬達控制、熱驗證、AI 輔助工程與客戶導向產品開發中學習的學生與年輕工程師。",cards([{tag:"Power Electronics",title:"Motor Drive & Measurement",text:"馬達驅動與量測：Learn voltage, current, RPM, thrust, torque, temperature, and system-level measurement through RobiDev and RobiLab."},{tag:"AI Engineering",title:"RobiAgent Workflow",text:"AI 輔助工程流程：Help organize engineering knowledge, technical documents, thermal pre-checks, layout review notes, and design-in workflows."},{tag:"Robotics / UAV",title:"Application Validation",text:"應用驗證：Participate in RobiThrust, RobiTorque, robotics actuator, UAV propulsion, and smart motion validation projects."}],"three"),"tint")}
  ...
  const sourceRouteAliases = {
    "/news-events/news-events-TaiChung-UAV": "/news-events/taichung-unmanned-vehicle-forum",
    "/news-events/news-events-computex-InnoVEX": "/news-events/2026-computex-innovex",
    "/news-events/news-events-swancor-MOU": "/news-events/swancor-tech-mou"
  };
  Object.entries(sourceRouteAliases).forEach(([alias, target]) => {
    const event = events[target];
    if (event) routeTable[alias] = {title:event.title, render:() => eventPage(event)};
  });
